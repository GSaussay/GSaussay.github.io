...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en-US" lang="en-US">
  ...
  <body>
    ...
    <div style="max-width:1200px; margin-left: auto; margin-right: auto">
      ...
      <img id = "first" alt="Twitter logo" title="Twitter" style="height:150px; margin-left: 7% ; margin-top: 5%; margin-right: 2%" src="assets/Picture1.jpg">
      <section id="tweetPresentation">
        <div id="description">
          <h3 style = "margin-left: 28%"> <br /> <b>Political Sentiment Analysis</b> </h3>
          <h4 style="margin-left: 25%; margin-right: 7%; text-align: justify; max-width:800px">
      ...
      <h4>
        <ul id="awsPoints" role="analysesAws" style="margin-left: 27%; margin-right: 7%; max-width:780px; text-align:justify">
          <li>
      ...
      <img alt="Amazon Web Services logo" title="Amazon Web Services" style="height: 90px; margin-left: 2%; margin-right:2%;margin-     top:5%" src="assets/Picture5.png">
      
      <h4 style="margin-left: 25%; margin-right: 7%; text-align: justify; max-width:800px">
        <br />
          For that purpose, I used Amazon Web Services, in particular <b>Amazon Elastic Compute Cloud (EC2)</b>, a scalable web server that provides high computing capacity in the Cloud and <b>Amazon Elastic MapReduce (EMR)</b>, a Hadoop-based framework       allowing to process vast amounts of data using the famous MapReduce data processing programming model.
        <br />
